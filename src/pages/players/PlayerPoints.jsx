...
const PlayerPoints = ({ playerId }) => {
    ...
    const handleCreatePoint = async () => {
        ...
        console.log(playerId,'kkk')

        try {
            // Send player in the payload (based on API schema)
            if(playerId){
                const payload = {
    ...
    return (
        <div className="p-6 bg-white rounded-lg border border-gray-100">
            <div className="mb-6 flex items-center justify-between">
                <h2 className="xl:text-2xl font-bold text-gray-800"> Points</h2>
                <button
            ...
            {loading ? (
               ...
               :
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">No Points found</p>
